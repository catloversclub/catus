...
export function encryptState(payload: Record<string, unknown>, secret: string): string {
...
export function safeReturnTo(raw: string | undefined, redirectBase: string): string | null {
  if (!raw) return null;
  // 길이 제한 + 제어문자/공백 차단
